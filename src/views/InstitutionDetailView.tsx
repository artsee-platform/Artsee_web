        ...
        <div className="lg:col-span-8 space-y-16 md:space-y-24">
          ...
          <section className="space-y-8 md:space-y-12">
            <div className="flex items-center justify-between">
              ...
              <p className="text-[9px] font-black text-ink/30 tracking-widest">精选专业百科</p>
            </div>
            <div className="grid sm:grid-cols-2 gap-6 md:gap-8">
              {displayPrograms.length > 0 ? displayPrograms.map((program) => {
                ...
                const summaryText = preferCjkRichText(
                  '该专业暂无详细介绍。',
                ...
                >
                  <div className="flex items-center justify-between mb-8">
                    ...
                    <div className="flex flex-wrap justify-end gap-2">
                      ...
                      <span className="px-4 py-1 bg-porcelain rounded-full text-[9px] font-black text-ink/30 tracking-widest">{program.degreeType || program.degree || '专业'}</span>
                    </div>
                  </div>
